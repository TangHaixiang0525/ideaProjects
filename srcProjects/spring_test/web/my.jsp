...
<head>
    ...
    <script src="./res/pinphp.js"></script>
...
<nav class="navbar navbar-default" style="border-radius: 0px;margin-bottom: 0px;">
    <div class="container-fluid" style="padding-left:0px;">
        <div class="navbar-header" style="background-color:#3A6DA4;padding-left:15px;"><a class="navbar-brand"
                                                                                          href="./res/幸福狐狸大系统.html">幸福狐狸大系统</a>
        </div>
            ...
            <ul class="nav navbar-nav navbar-right">
                <li>
                    <div class="cut_line"><span class="glyphicon glyphicon-user" style="margin-right:5px"></span><span
                            class="mr10">
	<% String request1 = request.getParameter("name"); %>
	<%=request1%>
</span><span class="mr10">一级分销</span><span class="glyphicon glyphicon-signal" style="margin-right:5px"></span><span
                            class="mr10">上级代理：卢曾洪</span><a
...
<div id="content">
    <div class="right_main">
        ...
        <div id="J_rframe" class="rframe_b" style="height: 993px;">
            <iframe id="rframe_0" src="./res/index.html" frameborder="0" scrolling="auto"
                    style="height:100%;width:100%;"></iframe>
        </div>
    </div>
</div>
<script src="./res/admin.js"></script>
<script src="./res/formvalidator.js"></script>
<script>
    //初始化弹窗
    (function (d) {
