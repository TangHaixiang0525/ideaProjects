...
public class bw
{
  ...
  private static String a(InputStream paramInputStream)
  {
    ...
    //   72: goto -45 -> 27
    //   75: astore 5
    //   77: getstatic 19	u/aly/bw:a	Ljava/lang/String;
    //   80: ldc 66
    //   82: aload 5
    //   84: invokestatic 71	u/aly/br:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Exception;)V
    //   87: aload_0
    //   88: invokevirtual 46	java/io/InputStream:close	()V
    //   91: aconst_null
    //   92: areturn
    //   93: astore 6
    //   95: getstatic 19	u/aly/bw:a	Ljava/lang/String;
    //   98: ldc 66
    //   100: aload 6
    //   102: invokestatic 71	u/aly/br:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Exception;)V
    //   105: aconst_null
    //   106: areturn
    //   107: astore_3
    //   108: aload_0
    ...
    //   113: athrow
    //   114: astore 4
    //   116: getstatic 19	u/aly/bw:a	Ljava/lang/String;
    //   119: ldc 66
    //   121: aload 4
    //   123: invokestatic 71	u/aly/br:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Exception;)V
    //   126: aconst_null
    //   127: areturn
    //   128: astore 9
    //   130: getstatic 19	u/aly/bw:a	Ljava/lang/String;
    //   133: ldc 66
    //   135: aload 9
    //   137: invokestatic 71	u/aly/br:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Exception;)V
    //   140: aconst_null
    //   141: areturn
    //
    // Exception table:
  ...
  private JSONObject a(String paramString)
  {
    ...
    while (true)
    {
      ...
      label490: br.c(a, i + ":\tFailed to send message. StatusCode = " + localHttpResponse.getStatusLine().getStatusCode() + cd.a + paramString);
  ...
  private JSONObject a(String paramString, JSONObject paramJSONObject)
  {
    ...
    int i = new Random().nextInt(1000);
    br.c(a, i + ":\trequest: " + paramString + cd.a + str1);
    ...
    while (true)
    {
      ...
      try
      {
        if (a())
        {
          byte[] arrayOfByte = cc.a("content=" + str1, Charset.defaultCharset().toString());
      ...
      catch (ClientProtocolException localClientProtocolException)
      {
        ...
        br.c(a, i + ":\tFailed to send message. StatusCode = " + localHttpResponse.getStatusLine().getStatusCode() + cd.a + paramString);
        return null;
      }
      catch (IOException localIOException)
      {
        br.c(a, i + ":\tIOException,Failed to send message." + paramString, localIOException);
        return null;
      }
      catch (JSONException localJSONException)
      {
        br.c(a, i + ":\tIOException,Failed to send message." + paramString, localJSONException);
        return null;
      }
  ...
  public <T extends by> T a(bx parambx, Class<T> paramClass)
  {
    ...
    if (bx.c.equals(str))
      localJSONObject = a(parambx.b());
    while (true)
      if (localJSONObject == null)
      {
        return null;
        if (bx.b.equals(str))
          localJSONObject = a(parambx.d, parambx.a());
      }
      else
      {
        try
        {
          by localby = (by)paramClass.getConstructor(new Class[] { JSONObject.class }).newInstance(new Object[] { localJSONObject });
          return localby;
        }
        catch (SecurityException localSecurityException)
        {
          br.b(a, "SecurityException", localSecurityException);
          return null;
        }
        catch (NoSuchMethodException localNoSuchMethodException)
        {
          while (true)
            br.b(a, "NoSuchMethodException", localNoSuchMethodException);
        }
        catch (IllegalArgumentException localIllegalArgumentException)
        {
          while (true)
            br.b(a, "IllegalArgumentException", localIllegalArgumentException);
        }
        catch (InstantiationException localInstantiationException)
        {
          while (true)
            br.b(a, "InstantiationException", localInstantiationException);
        }
        catch (IllegalAccessException localIllegalAccessException)
        {
          while (true)
            br.b(a, "IllegalAccessException", localIllegalAccessException);
        }
        catch (InvocationTargetException localInvocationTargetException)
        {
          while (true)
            br.b(a, "InvocationTargetException", localInvocationTargetException);
        }
