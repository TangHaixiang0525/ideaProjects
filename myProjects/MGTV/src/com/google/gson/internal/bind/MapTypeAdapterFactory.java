  ...
  implements TypeAdapter.Factory
{
  ...
  private TypeAdapter<?> getKeyAdapter(MiniGson paramMiniGson, Type paramType)
  {
  ...
  public <T> TypeAdapter<T> create(MiniGson paramMiniGson, TypeToken<T> paramTypeToken)
  {
    ...
    TypeAdapter localTypeAdapter1 = getKeyAdapter(paramMiniGson, arrayOfType[0]);
  ...
  private final class Adapter<K, V> extends TypeAdapter<Map<K, V>>
  {
      ...
      throws IOException
    {
      ...
      while (paramJsonReader.hasNext())
      {
        ...
        Object localObject1 = this.keyTypeAdapter.fromJsonElement(new JsonPrimitive(str));
      ...
      throws IOException
    {
      ...
      if (localIterator1.hasNext())
      {
        ...
        JsonElement localJsonElement = this.keyTypeAdapter.toJsonElement(localEntry1.getKey());
