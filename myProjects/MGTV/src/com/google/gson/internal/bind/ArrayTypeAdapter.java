...
public final class ArrayTypeAdapter<E> extends TypeAdapter<Object>
{
  public static final TypeAdapter.Factory FACTORY = new TypeAdapter.Factory()
  {
    public <T> TypeAdapter<T> create(MiniGson paramAnonymousMiniGson, TypeToken<T> paramAnonymousTypeToken)
    {
      ...
      return new ArrayTypeAdapter(paramAnonymousMiniGson, paramAnonymousMiniGson.getAdapter(TypeToken.get(localType2)), .Gson.Types.getRawType(localType2));
    }
  };
  ...
  {
    this.componentTypeAdapter = new TypeAdapterRuntimeTypeWrapper(paramMiniGson, paramTypeAdapter, paramClass);
