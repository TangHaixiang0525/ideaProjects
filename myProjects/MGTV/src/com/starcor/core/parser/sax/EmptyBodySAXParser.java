...
public class EmptyBodySAXParser<Result>
  implements IXmlParser<Result>
{
  public Result parser(InputStream paramInputStream)
  {
    ...
    while (true)
    {
      Logger.i("EmptyBodySAXParser", "parsere==" + (String)localObject);
      return localObject;
 ...
 * Qualified Name:     com.starcor.core.parser.sax.EmptyBodySAXParser
