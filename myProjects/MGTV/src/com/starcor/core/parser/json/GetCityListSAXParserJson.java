...
public class GetCityListSAXParserJson<Result>
  implements IXmlParser<Result>
{
  ...
  public Result parser(InputStream paramInputStream)
  {
    ...
    while (true)
    {
      Log.e("GetCityListSAXParserJson", "GetCityListSAXParserJson解析器解析得到的对象：cityStruct=" + this.cityStruct);
 ...
 * Qualified Name:     com.starcor.core.parser.json.GetCityListSAXParserJson
