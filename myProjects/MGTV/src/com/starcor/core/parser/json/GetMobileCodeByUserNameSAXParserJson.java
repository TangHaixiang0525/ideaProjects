...
public class GetMobileCodeByUserNameSAXParserJson<Result>
  implements IXmlParser<Result>
{
  ...
  public Result parser(byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      while (true)
      {
        Logger.i("GetMobileCodeByUserNameSAXParserJson", "GetMobileCodeByUserNameSAXParserJson解析器解析得到的对象：info=" + this.info.toString());
        return this.info;
        label210: JSONObject localJSONObject2 = new JSONObject(str);
        if (localJSONObject2.has("mobile"))
          this.info.mobile = localJSONObject2.getString("mobile");
 ...
 * Qualified Name:     com.starcor.core.parser.json.GetMobileCodeByUserNameSAXParserJson
