...
public class UserCenterRegisterParams extends Api
{
  public StringParams nns_params;
  public StringParams nns_version;

  public UserCenterRegisterParams(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    this.prefix = AppInfo.URL_n212_b;
    this.nns_func = new StringParams("nns_func");
    this.nns_func.setValue("user_center_register");
 ...
 * Qualified Name:     com.starcor.core.epgapi.params.UserCenterRegisterParams
