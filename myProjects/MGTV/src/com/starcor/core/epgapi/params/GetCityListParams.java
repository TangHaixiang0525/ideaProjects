...
public class GetCityListParams extends Api
{
  private StringParams nns_city_id;
  private StringParams nns_token;
  private StringParams nns_webtoken;

  public GetCityListParams(String paramString)
  {
    this.taksCategory = 100;
    this.prefix = AppInfo.URL_n100;
    this.nns_func.setValue("get_next_list");
 ...
 * Qualified Name:     com.starcor.core.epgapi.params.GetCityListParams
