...
public class AAAGetPriceInfoParams extends Api
{
  private StringParams nns_params;
  private StringParams nns_version;

  public AAAGetPriceInfoParams(String paramString1, String paramString2, int paramInt1, int paramInt2, String paramString3)
  {
    this.prefix = AppInfo.URL_n212_a;
    this.nns_func.setValue("aaa_get_price_by_product");
 ...
 * Qualified Name:     com.starcor.core.epgapi.params.AAAGetPriceInfoParams
