...
public class GetUserCenterInfoParams extends Api
{
  private StringParams nns_params;
  private StringParams nns_version;

  public GetUserCenterInfoParams(String paramString1, int paramInt, String paramString2)
  {
    this.prefix = AppInfo.URL_n212_a;
    this.nns_func.setValue("aaa_get_user_info");
 ...
 * Qualified Name:     com.starcor.core.epgapi.params.GetUserCenterInfoParams
