...
public class AAAGetLicenseParams extends Api
{
  private StringParams nns_params;
  private StringParams nns_version;

  public AAAGetLicenseParams(String paramString)
  {
    this.prefix = AppInfo.URL_n212_a;
    this.nns_func.setValue("aaa_get_license");
    this.nns_params = new StringParams("nns_params");
    try
    {
      JSONObject localJSONObject1 = new JSONObject();
      localJSONObject1.put("device_id", paramString);
 ...
 * Qualified Name:     com.starcor.core.epgapi.params.AAAGetLicenseParams
