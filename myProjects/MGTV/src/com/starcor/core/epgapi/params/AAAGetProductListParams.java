...
public class AAAGetProductListParams extends Api
{
  private StringParams nns_params;
  private StringParams nns_version;

  public AAAGetProductListParams(String paramString1, String paramString2, int paramInt1, int paramInt2)
  {
    this.prefix = AppInfo.URL_n212_a;
    this.nns_func.setValue("aaa_product_list");
    ...
    try
    {
      ...
      localJSONObject1.put("vip_id", paramInt2);
 ...
 * Qualified Name:     com.starcor.core.epgapi.params.AAAGetProductListParams
