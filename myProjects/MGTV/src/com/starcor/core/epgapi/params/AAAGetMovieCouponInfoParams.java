...
public class AAAGetMovieCouponInfoParams extends Api
{
  private StringParams nns_params;
  private StringParams nns_version;

  public AAAGetMovieCouponInfoParams(String paramString1, int paramInt, String paramString2)
  {
    this.prefix = AppInfo.URL_n212_a;
    this.nns_func.setValue("aaa_view_coupon_list");
 ...
 * Qualified Name:     com.starcor.core.epgapi.params.AAAGetMovieCouponInfoParams
