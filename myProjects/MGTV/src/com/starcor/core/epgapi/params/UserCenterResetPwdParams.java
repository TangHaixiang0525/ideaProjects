...
public class UserCenterResetPwdParams extends Api
{
  public StringParams nns_params;
  public StringParams nns_version;

  public UserCenterResetPwdParams(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    this.prefix = AppInfo.URL_n212_b;
    this.nns_func = new StringParams("nns_func");
    this.nns_func.setValue("user_center_reset_pwd");
    this.nns_params = new StringParams("nns_params");
    try
    {
      JSONObject localJSONObject1 = new JSONObject();
      localJSONObject1.put("username", paramString1);
      localJSONObject1.put("newpwd", paramString2);
      localJSONObject1.put("mobilecode", paramString3);
      localJSONObject1.put("license", paramString4);
 ...
 * Qualified Name:     com.starcor.core.epgapi.params.UserCenterResetPwdParams
