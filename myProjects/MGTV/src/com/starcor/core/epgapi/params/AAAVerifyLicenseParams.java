...
public class AAAVerifyLicenseParams extends Api
{
  private StringParams nns_params;
  private StringParams nns_version;

  public AAAVerifyLicenseParams(String paramString)
  {
    this.prefix = AppInfo.URL_n212_a;
    this.nns_func.setValue("aaa_device_auth");
 ...
 * Qualified Name:     com.starcor.core.epgapi.params.AAAVerifyLicenseParams
