...
public class UserCenterGetMobileCodeByUserNameParams extends Api
{
  private StringParams nns_params;
  public StringParams nns_version;

  public UserCenterGetMobileCodeByUserNameParams(String paramString1, String paramString2)
  {
    this.prefix = AppInfo.URL_n212_b;
    this.nns_func.setValue("user_center_mobile_auth");
 ...
 * Qualified Name:     com.starcor.core.epgapi.params.UserCenterGetMobileCodeByUserNameParams
