...
public class UserCenterBindMobileParams extends Api
{
  private StringParams nns_params;
  public StringParams nns_version;

  public UserCenterBindMobileParams(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6)
  {
    this.prefix = AppInfo.URL_n212_b;
    this.nns_func.setValue("user_center_bind_mobile");
    ...
    try
    {
      ...
      localJSONObject1.put("mobilecode", paramString5);
      localJSONObject1.put("license", paramString6);
  ...
  public String toString()
  {
    ...
    if (!str.contains("?"))
      str = str + "?";
    return str + this.nns_func + this.nns_params + this.suffix;
  }
}

/* Location:           C:\Users\THX\Desktop\aa\aa\反编译工具包\out\classes_dex2jar.jar
 * Qualified Name:     com.starcor.core.epgapi.params.UserCenterBindMobileParams
