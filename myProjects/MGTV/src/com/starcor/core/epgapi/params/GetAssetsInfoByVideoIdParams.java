...
public class GetAssetsInfoByVideoIdParams extends Api
{
  private StringParams nns_token;
  private StringParams nns_webtoken;
  private StringParams video_id;

  public GetAssetsInfoByVideoIdParams(String paramString)
  {
    this.taksCategory = 15;
    this.prefix = com.starcor.core.domain.AppInfo.URL_n3_a_i[3];
    this.nns_func.setValue("get_video_assets_info");
  ...
  public String toString()
  {
    ...
    if (!str.contains("?"))
      str = str + "?";
    return str + this.nns_func + this.video_id + this.nns_token + this.nns_webtoken + this.suffix;
  }
}

/* Location:           C:\Users\THX\Desktop\aa\aa\反编译工具包\out\classes_dex2jar.jar
 * Qualified Name:     com.starcor.core.epgapi.params.GetAssetsInfoByVideoIdParams
