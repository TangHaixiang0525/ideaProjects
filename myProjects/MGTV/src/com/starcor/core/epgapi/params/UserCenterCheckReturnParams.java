...
public class UserCenterCheckReturnParams extends Api
{
  private StringParams nns_params;
  public StringParams nns_version;

  public UserCenterCheckReturnParams(String paramString1, String paramString2)
  {
    this.prefix = AppInfo.URL_n212_b;
    this.nns_func.setValue("user_center_qrcode");
    this.nns_params = new StringParams("nns_params");
    try
    {
      JSONObject localJSONObject1 = new JSONObject();
      localJSONObject1.put("rcode", paramString1);
 ...
 * Qualified Name:     com.starcor.core.epgapi.params.UserCenterCheckReturnParams
