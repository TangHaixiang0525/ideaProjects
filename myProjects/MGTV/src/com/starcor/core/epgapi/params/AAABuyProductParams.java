...
public class AAABuyProductParams extends Api
{
  private StringParams nns_params;
  private StringParams nns_version;

  public AAABuyProductParams(int paramInt1, String paramString1, String paramString2, int paramInt2, int paramInt3, String paramString3, String paramString4)
  {
    this.prefix = AppInfo.URL_n212_a;
    this.nns_func.setValue("aaa_buy_product");
    ...
    try
    {
      ...
      localJSONObject1.put("channel", paramString4);
      if (!TextUtils.isEmpty(paramString3))
        localJSONObject1.put("ext_data", "mobile=" + paramString3);
 ...
 * Qualified Name:     com.starcor.core.epgapi.params.AAABuyProductParams
