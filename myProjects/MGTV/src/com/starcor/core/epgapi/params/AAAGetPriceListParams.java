...
public class AAAGetPriceListParams extends Api
{
  private StringParams nns_params;
  private StringParams nns_version;

  public AAAGetPriceListParams(String paramString)
  {
    this.prefix = AppInfo.URL_n212_a;
    this.nns_func.setValue("aaa_price_list");
 ...
 * Qualified Name:     com.starcor.core.epgapi.params.AAAGetPriceListParams
