...
public class AAAUseMovieCouponParams extends Api
{
  private StringParams nns_params;
  private StringParams nns_version;

  public AAAUseMovieCouponParams(String paramString1, int paramInt, String paramString2, String paramString3, String paramString4)
  {
    this.prefix = AppInfo.URL_n212_a;
    this.nns_func.setValue("aaa_view_coupon_use");
    ...
    try
    {
      ...
      if ("0".equals(paramString4))
        localJSONObject1.put("asset_id", paramString3);
      while (true)
      {
        ...
        return;
        localJSONObject1.put("tv_channel_id", paramString3);
      }
    }
 ...
 * Qualified Name:     com.starcor.core.epgapi.params.AAAUseMovieCouponParams
