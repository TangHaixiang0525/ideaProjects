...
public class UserCenterUnbindWebChatParams extends Api
{
  public StringParams nns_params;
  public StringParams nns_version;

  public UserCenterUnbindWebChatParams(String paramString1, String paramString2)
  {
    this.prefix = AppInfo.URL_n212_b;
    this.nns_func = new StringParams("nns_func");
    this.nns_func.setValue("user_center_wechat_unbind");
 ...
 * Qualified Name:     com.starcor.core.epgapi.params.UserCenterUnbindWebChatParams
