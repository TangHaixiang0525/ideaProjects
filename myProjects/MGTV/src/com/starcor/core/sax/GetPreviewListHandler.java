...
public class GetPreviewListHandler extends DefaultHandler
{
  private PreviewList indexList;
  private PreviewList.Item item;
    ...
    throws SAXException
  {
    ...
    do
    {
      ...
      {
        this.item.videoIndex = XulUtils.tryParseInt(str);
        return;
      }
      if ("preview_type".equals(this.tagName))
      {
        this.item.previewType = str;
        return;
      }
  ...
  public void startDocument()
    throws SAXException
  {
    this.indexList = new PreviewList();
    super.startDocument();
  }
    ...
    throws SAXException
  {
    ...
    if (paramString2.equalsIgnoreCase("i"))
    {
      PreviewList localPreviewList = this.indexList;
      localPreviewList.getClass();
      this.item = new PreviewList.Item(localPreviewList);
    }
  }
}

/* Location:           C:\Users\THX\Desktop\aa\aa\反编译工具包\out\classes_dex2jar.jar
 * Qualified Name:     com.starcor.core.sax.GetPreviewListHandler
