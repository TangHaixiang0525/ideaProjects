...
public class SccmsApiDelCatchVideoRecordTask extends ServerApiCachedTask
{
  String collectIds = null;
  ISccmsApiDelCatchVideoRecordTaskListener lsr;

  public SccmsApiDelCatchVideoRecordTask(String paramString)
  {
  ...
  public void perform(SCResponse paramSCResponse)
  {
    ...
    try
    {
      ...
      Logger.i("SccmsApiDelCatchVideoRecordTask", " result:" + str);
  ...
  public void setListener(ISccmsApiDelCatchVideoRecordTaskListener paramISccmsApiDelCatchVideoRecordTaskListener)
  {
    this.lsr = paramISccmsApiDelCatchVideoRecordTaskListener;
  }

  public static abstract interface ISccmsApiDelCatchVideoRecordTaskListener
  {
 ...
 * Qualified Name:     com.starcor.sccms.api.SccmsApiDelCatchVideoRecordTask
