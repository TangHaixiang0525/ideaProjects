...
public class SccmsApiGetPlayRecordV2Task extends ServerApiCachedTask
{
  private String TAG = SccmsApiGetPlayRecordV2Task.class.getSimpleName();
  private ISccmsApiGetPlayRecordV2TaskListener lsr;
  ...
  {
    GetCollectListV2Params localGetCollectListV2Params = new GetCollectListV2Params("N40_A_4");
  ...
  public void setListener(ISccmsApiGetPlayRecordV2TaskListener paramISccmsApiGetPlayRecordV2TaskListener)
  {
    this.lsr = paramISccmsApiGetPlayRecordV2TaskListener;
  }

  public static abstract interface ISccmsApiGetPlayRecordV2TaskListener
  {
 ...
 * Qualified Name:     com.starcor.sccms.api.SccmsApiGetPlayRecordV2Task
