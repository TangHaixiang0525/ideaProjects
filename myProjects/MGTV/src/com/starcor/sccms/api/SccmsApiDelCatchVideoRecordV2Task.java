...
public class SccmsApiDelCatchVideoRecordV2Task extends ServerApiCachedTask
{
  private String TAG = SccmsApiDelCatchVideoRecordV2Task.class.getSimpleName();
  String collectIds = null;
  ISccmsApiDelCatchVideoRecordV2TaskListener lsr;
  VideoInfo videoinfo = null;

  public SccmsApiDelCatchVideoRecordV2Task(String paramString, VideoInfo paramVideoInfo)
  {
  ...
  {
    RemoveCollectV2Params localRemoveCollectV2Params = new RemoveCollectV2Params(this.collectIds, this.videoinfo, 3);
  ...
  public void perform(SCResponse paramSCResponse)
  {
    ...
    try
    {
      ...
      Logger.i(this.TAG, "删除追剧result:" + localArrayList);
  ...
  public void setListener(ISccmsApiDelCatchVideoRecordV2TaskListener paramISccmsApiDelCatchVideoRecordV2TaskListener)
  {
    this.lsr = paramISccmsApiDelCatchVideoRecordV2TaskListener;
  }

  public static abstract interface ISccmsApiDelCatchVideoRecordV2TaskListener
  {
 ...
 * Qualified Name:     com.starcor.sccms.api.SccmsApiDelCatchVideoRecordV2Task
