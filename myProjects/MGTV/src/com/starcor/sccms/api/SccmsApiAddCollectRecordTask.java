...
public class SccmsApiAddCollectRecordTask extends ServerApiCachedTask
{
  ISccmsApiAddCollectRecordTaskListener lsr;
  AddCollectParams para = null;

  public SccmsApiAddCollectRecordTask(AddCollectParams paramAddCollectParams)
  {
  ...
  public void perform(SCResponse paramSCResponse)
  {
    ...
    try
    {
      ...
      Logger.i("SccmsApiAddCollectRecordTask", " result:" + str);
  ...
  public void setListener(ISccmsApiAddCollectRecordTaskListener paramISccmsApiAddCollectRecordTaskListener)
  {
    this.lsr = paramISccmsApiAddCollectRecordTaskListener;
  }

  public static abstract interface ISccmsApiAddCollectRecordTaskListener
  {
 ...
 * Qualified Name:     com.starcor.sccms.api.SccmsApiAddCollectRecordTask
