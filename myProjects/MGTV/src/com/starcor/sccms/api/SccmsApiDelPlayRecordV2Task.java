...
public class SccmsApiDelPlayRecordV2Task extends ServerApiCachedTask
{
  private String TAG = SccmsApiDelPlayRecordV2Task.class.getSimpleName();
  String collectIds = null;
  ISccmsApiDelPlayRecordV2TaskListener lsr;

  public SccmsApiDelPlayRecordV2Task(String paramString)
  {
  ...
  {
    RemoveCollectV2Params localRemoveCollectV2Params = new RemoveCollectV2Params(this.collectIds, null, 2);
  ...
  public void setListener(ISccmsApiDelPlayRecordV2TaskListener paramISccmsApiDelPlayRecordV2TaskListener)
  {
    this.lsr = paramISccmsApiDelPlayRecordV2TaskListener;
  }

  public static abstract interface ISccmsApiDelPlayRecordV2TaskListener
  {
 ...
 * Qualified Name:     com.starcor.sccms.api.SccmsApiDelPlayRecordV2Task
