...
public class SetAllMessageUnreadTask extends AbstractSubTask
{
  ...
  public void doRunTask()
  {
    ...
    while (true)
    {
      ...
      Logger.i(this.TAG, "设置" + i + "条" + getTopic() + "类型的消息数据为未读！" + this.mDbProvider.getmContext());
      GeneralUtils.writePreferences("message_id", GeneralUtils.getCurrentUnreadIds(this.mDbProvider.getmContext()), this.mDbProvider.getmContext());
      cleanUp();
      return;
      boolean bool = IMQTTMessageDBUpdater.TopicTableUpdateActionType.SET_ALL_MY_MESSAGE_UNREAD.equals(this.mType);
      str = null;
      arrayOfString = null;
      if (bool)
      {
  ...
  public String getTopic()
  {
    ...
    {
      return str;
      if (IMQTTMessageDBUpdater.TopicTableUpdateActionType.SET_ALL_MY_MESSAGE_UNREAD.equals(this.mType))
        return "my_msg";
    }
    while (!IMQTTMessageDBUpdater.TopicTableUpdateActionType.SET_ALL_ADMIN_TOPIC_MESSAGE_UNREAD.equals(this.mType));
    return "admin";
  }
  ...
  public void initUriMap()
  {
    ...
    this.mUriMap.put(IMQTTMessageDBUpdater.TopicTableUpdateActionType.SET_ALL_SYSTEM_MESSAGE_UNREAD, localUri1);
    this.mUriMap.put(IMQTTMessageDBUpdater.TopicTableUpdateActionType.SET_ALL_MY_MESSAGE_UNREAD, localUri1);
    this.mUriMap.put(IMQTTMessageDBUpdater.TopicTableUpdateActionType.SET_ALL_ADMIN_TOPIC_MESSAGE_UNREAD, localUri2);
  }
 ...
 * Qualified Name:     com.starcor.hunan.msgsys.threads.SetAllMessageUnreadTask
