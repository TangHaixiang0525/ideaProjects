...
public class OpenPlaybillRecommendPageHelper extends MediaAssetHelperBase
{
  ...
  public OpenPlaybillRecommendPageHelper(Context paramContext)
  {
    super(paramContext, OpenPlaybillRecommendPageHelper.class.getSimpleName());
  }
  ...
  protected void startSubAction()
  {
    try
    {
      ...
      if (!TextUtils.isEmpty(str6))
      {
        ...
        localIntent.putExtra("FromCommend", true);
      }
 ...
 * Qualified Name:     com.starcor.hunan.msgsys.mediaplayerhelper.helper.OpenPlaybillRecommendPageHelper
