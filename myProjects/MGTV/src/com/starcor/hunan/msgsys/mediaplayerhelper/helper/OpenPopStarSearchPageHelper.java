...
public class OpenPopStarSearchPageHelper extends MediaAssetHelperBase
{
  ...
  public OpenPopStarSearchPageHelper(Context paramContext)
  {
    super(paramContext, OpenPopStarSearchPageHelper.class.getSimpleName());
  }
  ...
  protected void startSubAction()
  {
    try
    {
      ...
      localIntent.putExtra("actions", "m_open_popstar_search_page");
 ...
 * Qualified Name:     com.starcor.hunan.msgsys.mediaplayerhelper.helper.OpenPopStarSearchPageHelper
