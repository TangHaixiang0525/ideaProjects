...
public class PublicTopicMessageColumns extends DataBaseColumns
{
  private static final Uri CONTENT_URI = Uri.parse("content://com.starcor.mango.hunan.database/public_topic_msg_table");
  private static final Map<String, String> KEY_MAP = new HashMap();
  public static final String TABLE_NAME = "public_topic_msg_table";
  ...
  {
    return "public_topic_msg_table";
  }
}

/* Location:           C:\Users\THX\Desktop\aa\aa\反编译工具包\out\classes_dex2jar.jar
 * Qualified Name:     com.starcor.hunan.db.PublicTopicMessageColumns
